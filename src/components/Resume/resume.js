        ...
        <section className="resume">
            <div className="row d-flex justify-content-center m-3">
                <div className="bio">
                    ...
                    <a className="resume-download" href="https://drive.google.com/file/d/1XeTKS1mDQy0dW4cYo1eyhSKMqqi_hWHk/view?usp=sharing" target="_blank" rel="noreferrer" download><h3 className="resume-download">View Resume</h3></a>
